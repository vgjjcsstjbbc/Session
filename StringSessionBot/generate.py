...
async def generate_session(bot, msg, telethon=False):
    ...
    await msg.reply("جـاࢪي إࢪسـال الكـود إلــى الـحفوضـات انتـظࢪ قـليـلًا......")
    if telethon:
